            ...
            <div id="newsfeed">
                ...
                <div id="all-posts">
                    {Object.values(this.state.posts).map(post => (
                        <PostItem post={post} key={post.id} fetchUser={this.props.fetchUser} history={this.props.history} editPost={this.props.editPost} fetchPost={this.props.fetchPost} rerenderParentCallback={this.rerenderParentCallback}/>
                    ))}
                </div>
            </div>
        );
